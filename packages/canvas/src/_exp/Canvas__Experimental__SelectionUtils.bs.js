...
function getRectCorner(clientX, clientY, param, tools) {
  ...
  var corner = isPointNearPoint(clientX, clientY, x, y, Canvas__Experimental__Constants.tolerance) ? "TopLeft" : (
      isPointNearPoint(clientX, clientY, x + width, y, Canvas__Experimental__Constants.tolerance) ? "TopRight" : (
          isPointNearPoint(clientX, clientY, x, y + height, Canvas__Experimental__Constants.tolerance) ? "BottomLeft" : (
              isPointNearPoint(clientX, clientY, x + width, y + height, Canvas__Experimental__Constants.tolerance) ? "BottomRight" : (
                  clientX >= x + Canvas__Experimental__Constants.tolerance && clientX <= x + width - Canvas__Experimental__Constants.tolerance ? (
                      clientY >= y - Canvas__Experimental__Constants.tolerance && clientY <= y + Canvas__Experimental__Constants.tolerance ? "Top" : (
                          clientY >= y + height - Canvas__Experimental__Constants.tolerance && clientY <= y + height + Canvas__Experimental__Constants.tolerance ? "Bottom" : undefined
                        )
                    ) : (
                      clientY >= y + Canvas__Experimental__Constants.tolerance && clientY <= y + height - Canvas__Experimental__Constants.tolerance ? (
                          clientX >= x - Canvas__Experimental__Constants.tolerance && clientX <= x + Canvas__Experimental__Constants.tolerance ? "Left" : (
                              clientX >= x + width - Canvas__Experimental__Constants.tolerance && clientX <= x + width + Canvas__Experimental__Constants.tolerance ? "Right" : undefined
                            )
                        ) : undefined
                    )
                )
...
function getLineCorner(clientX, clientY, param, tools) {
  ...
  var corner = isPointNearPoint(clientX, clientY, start.x, start.y, Canvas__Experimental__Constants.tolerance) ? "Start" : (
      isPointNearPoint(clientX, clientY, end.x, end.y, Canvas__Experimental__Constants.tolerance) ? "End" : undefined
    );
  if (corner === undefined) {
    return ;
  }
