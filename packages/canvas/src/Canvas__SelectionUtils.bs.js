...
function resizeRect(rect, clientX, clientY, corner) {
  switch (corner) {
    ...
    case "TopLeft" :
        var newrecord = Caml_obj.obj_dup(rect);
        newrecord.height = rect.y + rect.height - clientY;
        newrecord.width = rect.x + rect.width - clientX;
        newrecord.y = clientY;
        newrecord.x = clientX;
        return newrecord;
    case "TopRight" :
        var newrecord$1 = Caml_obj.obj_dup(rect);
        newrecord$1.height = rect.y + rect.height - clientY;
        newrecord$1.width = clientX - rect.x;
        newrecord$1.y = clientY;
        return newrecord$1;
    case "BottomLeft" :
        var newrecord$2 = Caml_obj.obj_dup(rect);
        newrecord$2.height = clientY - rect.y;
        newrecord$2.width = rect.x + rect.width - clientX;
        newrecord$2.x = clientX;
        return newrecord$2;
    case "BottomRight" :
        var newrecord$3 = Caml_obj.obj_dup(rect);
        newrecord$3.height = clientY - rect.y;
        newrecord$3.width = clientX - rect.x;
        return newrecord$3;
    case "Top" :
        var newrecord$4 = Caml_obj.obj_dup(rect);
        newrecord$4.height = rect.y + rect.height - clientY;
        newrecord$4.y = clientY;
        return newrecord$4;
    case "Bottom" :
        var newrecord$5 = Caml_obj.obj_dup(rect);
        newrecord$5.height = clientY - rect.y;
        return newrecord$5;
    case "Left" :
        var newrecord$6 = Caml_obj.obj_dup(rect);
        newrecord$6.width = rect.x + rect.width - clientX;
        newrecord$6.x = clientX;
        return newrecord$6;
    case "Right" :
        var newrecord$7 = Caml_obj.obj_dup(rect);
        newrecord$7.width = clientX - rect.x;
        return newrecord$7;
...
function resizeLine(line, clientX, clientY, corner) {
  switch (corner) {
    case "Start" :
        ...
        return newrecord;
    case "End" :
        var newrecord$1 = Caml_obj.obj_dup(line);
        newrecord$1.end = {
          x: clientX,
          y: clientY
        };
