...
export const getElementId: (_1:Canvas__Models_element) => string = Canvas__ElementUtilsJS.getElementId as any;

export const isSelected: (_1:string, _2:string[]) => boolean = Canvas__ElementUtilsJS.isSelected as any;

export const getLineCenterForText: (_1:Canvas__Models_Line_t, text:string, font:string) => Canvas__Models_Vec_t = Canvas__ElementUtilsJS.getLineCenterForText as any;

export const getRectCenterForText: (_1:Canvas__Models_Rect_t, text:string, font:string) => Canvas__Models_Vec_t = Canvas__ElementUtilsJS.getRectCenterForText as any;

export const updateElementLabel: (_1:Canvas__Models_element[], id:string, label:(undefined | string)) => Canvas__Models_element[] = Canvas__ElementUtilsJS.updateElementLabel as any;
