...
module.exports = {
  forbidden: [
    {
      name: "no-import-from-apps-to-packages",
      severity: "error",
      comment: "Modules in `packages` can't use modules from `apps`.",
      from: { path: "^packages/" },
      to: { path: "^apps/" },
    },
    ...
    },
    {
      ...
      from: {
        ...
        pathNot: [
          ...
          "(^|/)(babel|webpack|app)\\.config\\.(js|cjs|mjs|ts|json)$", // other configs
          ".next",
          "rescript-shims",
          "node_modules",
          "testing/__mocks__",
          ...
          "uuid",
          // utils
          "packages/utils/src/Utils.bs.js",
          "packages/utils/src/gentype/Utils__FixedGenType.bs.js",
          // rescript-global
          "packages/rescript-global/src/RescriptGlobal.bs.js",
    ...
    },
    {
      ...
      from: {
        pathNot: [
          ...
          "apps/.*/(__tests__)/.*",
          "packages/.*/(__tests__)/.*",
          "(webpack|next|jest)\\.config\\.js",
          // Packages required by this folder don't need to be in our root package.json (react, @apollo-client)
          "rescript-shims",
          "testing",
        ],
      },
    ...
    },
    {
      ...
      from: {
        path: "^(packages)",
        pathNot: [
          "\\.(spec|test|play|d)\\.(js|mjs|cjs|ts|tsx|ls|coffee|litcoffee|coffee\\.md)$",
        ],
      },
      to: {
        ...
        pathNot: [
          ...
          "node_modules/@glennsl/rescript-jest",
        ],
      },
    },
    {
...
// generated: dependency-cruiser@9.23.3 on 2022-01-19T14:07:09.680Z
